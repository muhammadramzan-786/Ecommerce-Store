...
const hanleSubmit = (e) => {
  ...
  return (
    <div className="relative @container">
      {/* TABS */}
      <div className="@xsm:flex gap-8 p-4 sticky top-15 bg-white z-40 space-y-5 @xsm:space-y-0">
        {tabs.map((item)=>(
          <Button
          text={
      ...
      {tab === "ready-for-review" && (
        <div className="p-4">
          ...
          {readyToReviewProducts.length>0 ?
          ...
          )) : <p className="text-2xl font-bold text-gray-900 mb-3">No Products for Review</p>}
        </div>
      )}

      {/* ------------ REVIEWED TAB ------------- */}
     {tab === "reviewed" && (
  <div className="p-4 md:p-8 w-full max-w-[1800px] mt-5 @xsm:mt-0">
    {ReviewedProLoading && (
       <svg className="animate-spin -ml-1 mr-2 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
    ...
    {ReviewProducts?.length > 0 ? (
      ...
      /* Empty State */
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-2 sm:p-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <AppLink to="/shop" className="px-6 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors">
            Continue Shopping
          </AppLink>
        </div>
      </div>
